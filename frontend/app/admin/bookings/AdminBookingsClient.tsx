          ...
          <div
            ...
            {booking.payment_proof_sent && booking.payment_proof_url && (
              <div style={{ marginTop: "12px", display: "flex", flexDirection: "column", gap: "6px" }}>
                <span style={{ fontSize: "0.82rem", color: "#B09080", fontWeight: 500 }}>Bukti Pembayaran (Scan/Upload):</span>
                <div 
                  onClick={() => setZoomImageUrl(`${backendUrl}${booking.payment_proof_url}`)}
                  style={{
                    width: "100%",
                    height: "140px",
                    borderRadius: "8px",
                  ...
                  onMouseEnter={(e) => e.currentTarget.style.borderColor = "#C4788A"}
                  onMouseLeave={(e) => e.currentTarget.style.borderColor = "#F0D9E0"}
                >
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img 
                    src={`${backendUrl}${booking.payment_proof_url}`} 
                    alt="Bukti Transfer" 
